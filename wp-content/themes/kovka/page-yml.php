...
<section class="inner-page-banner bg-common" data-bg-image="<?php echo get_template_directory_uri()?>/img/figure/breadcumb.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
              <div class="breadcrumbs-area">
                <h1>Не можем найти эту страницу</h1>
...
<section class="error-page-wrap-layout1">
    ...
    <div class="container">
        <div class="error-page-box-layout1">
            <div class="error-img">
                <img width="450" src="/wp-content/uploads/2021/11/404_error.png" alt="404">
            </div>
            <!-- <div class="item-subtitle">Перейти на главную страницу</div> -->
			<br>
			<p><a href="/" class="item-btn">Перейти на главную страницу</a></p>
        </div>
    </div>
    <div id="Clouds">
...
xml_yml_generation_page();

function xml_yml_generation_page()
{
